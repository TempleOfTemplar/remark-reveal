...
import { getOptions, getAssetsDir, getPath, getStaticDir, getSlideOptions, getFilesGlob } from './config';
import { md, isDirectory, isFile, parseYamlFrontMatter, getFilePaths, isAbsoluteURL } from './util';
import { revealBasePath, highlightThemePath } from './constants';
import { renderFile } from './render';
import { renderListFile } from './listing';
...
export const writeStatic = async () => {
  ...
  const faviconPath = path.join(process.cwd(), getPath() as any, 'favicon.ico');
